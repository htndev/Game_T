  ...
  if ( isFirst ) {
    ...
    for ( let row = 0; row < tblHoriz.length; row++ ) {
      ...
      if ( typeof obj === 'object' ) {
        ...
        duplicateTable( tbl, simplifyField, obj, 'row', `Û<sub>P<sub>1</sub></sub>(A<sub>${ obj.best[ 0 ].parentElement.getAttribute( 'data-row' ) }</sub>; Š<sub>P<sub>1</sub></sub>${ firstPlayerCropped ? '\'' : '' }) > Û<sub>P<sub>1</sub></sub>(B<sub>${ obj.worst[ 0 ].parentElement.getAttribute( 'data-row' ) }</sub>; Š<sub>P<sub>1</sub></sub>${ firstPlayerCropped ? '\'' : '' })` );
    ...
    if ( obj === false ) {
      ...
      for ( let row = 0; row < tblVert.length; row++ ) {
        ...
        if ( typeof obj === 'object' ) {
          ...
          tmpTbl.innerHTML = tbl.innerHTML;
          fillTableFromMain( tbl, tmpTbl );
          duplicateTable( tbl, simplifyField, obj, 'col', `Û<sub>P<sub>2</sub></sub>(B<sub>${ obj.best[ 0 ].parentElement.getAttribute( 'data-col' ) }</sub>; Š<sub>P<sub>2</sub></sub>${ secondPlayerCropped ? '\'' : '' }) > Û<sub>P<sub>2</sub></sub>(B<sub>${ obj.worst[ 0 ].parentElement.getAttribute( 'data-col' ) }</sub>; Š<sub>P<sub>2</sub></sub>${ secondPlayerCropped ? '\'' : '' })` );
    ...
    if ( obj === false ) {
      ...
      for ( let row = 0; row < tblHoriz.length; row++ ) {
        ...
        if ( typeof obj === 'object' ) {
          ...
          tmpTbl.innerHTML = tbl.innerHTML;
          fillTableFromMain( tbl, tmpTbl );
          duplicateTable( tbl, simplifyField, obj, 'row', `Û<sub>P<sub>1</sub></sub>(A<sub>${ obj.best[ 0 ].parentElement.getAttribute( 'data-row' ) }</sub>; Š<sub>P<sub>1</sub></sub>) > Û<sub>P<sub>1</sub></sub>(B<sub>${ obj.worst[ 0 ].parentElement.getAttribute( 'data-row' ) }</sub>; Š<sub>P<sub>1</sub></sub>${ firstPlayerCropped ? '\'' : '' })` );
          firstPlayerCropped = true;
          cropAuto( tbl, rowNum, 'row' );
          autoCropTable = tbl.cloneNode( true );
          return autoCrop( autoCropTable, false );
